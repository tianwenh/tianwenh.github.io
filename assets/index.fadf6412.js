var D=Object.defineProperty,I=Object.defineProperties;var M=Object.getOwnPropertyDescriptors;var f=Object.getOwnPropertySymbols;var j=Object.prototype.hasOwnProperty,F=Object.prototype.propertyIsEnumerable;var w=(n,a,r)=>a in n?D(n,a,{enumerable:!0,configurable:!0,writable:!0,value:r}):n[a]=r,u=(n,a)=>{for(var r in a||(a={}))j.call(a,r)&&w(n,r,a[r]);if(f)for(var r of f(a))F.call(a,r)&&w(n,r,a[r]);return n},y=(n,a)=>I(n,M(a));import{R as t,s as k,j as p,L as g,O as L,r as d,a as O,g as R,N as P,c as C,u as X,b as z,d as c,e as b,f as B,h as G,B as q}from"./vendor.ca188348.js";const A=function(){const a=document.createElement("link").relList;if(a&&a.supports&&a.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))e(s);new MutationObserver(s=>{for(const o of s)if(o.type==="childList")for(const h of o.addedNodes)h.tagName==="LINK"&&h.rel==="modulepreload"&&e(h)}).observe(document,{childList:!0,subtree:!0});function r(s){const o={};return s.integrity&&(o.integrity=s.integrity),s.referrerpolicy&&(o.referrerPolicy=s.referrerpolicy),s.crossorigin==="use-credentials"?o.credentials="include":s.crossorigin==="anonymous"?o.credentials="omit":o.credentials="same-origin",o}function e(s){if(s.ep)return;s.ep=!0;const o=r(s);fetch(s.href,o)}};A();function H(n={}){const{wrapper:a}=n.components||{};return a?t.createElement(a,n,t.createElement(r)):r();function r(){const e=Object.assign({blockquote:"blockquote",p:"p",a:"a",h2:"h2",ol:"ol",li:"li",ul:"ul",code:"code",pre:"pre",span:"span",h3:"h3"},n.components);return t.createElement(t.Fragment,null,t.createElement(e.blockquote,null,`
...
`,t.createElement(e.p,null,"Other general step up (eslint, prettier) are omitted here, but you can find resources online or copy ",t.createElement(e.a,{href:"https://github.com/tianwenh/vite-template"},"my template"),"."),`
...
`),`
`,t.createElement(e.p,null,"Just follow github repo tutoirals, install and add to ",t.createElement(e.code,null,"vite.config.ts"),". I also assembled them together:"),`
...
`,t.createElement(e.p,null,"I also made dark mode. It auto detects user system preference, and persists user setup in local storage."),`
`,t.createElement(e.h2,{id:"ssr"},t.createElement(e.a,{className:"header-anchor",href:"#ssr"},"#"),"SSR"),`
`,t.createElement(e.p,null,"To begin, follow vite SSR tutoirals. I did some modification, and put together a plugin to fit in my use case."),`
...
`,t.createElement(e.p,null,"For deployment, ",t.createElement(e.code,null,"gh-pages")," is used for manual push. I also created a github action that auto builds and deploys the latest push from ",t.createElement(e.code,null,"main")," to ",t.createElement(e.code,null,"gh-pages"),"."),`
`,t.createElement(e.h2,{id:"how-to-use"},t.createElement(e.a,{className:"header-anchor",href:"#how-to-use"},"#"),"How to use"),`
`,t.createElement(e.p,null,"I made everything generic into a ",t.createElement(e.a,{href:"https://github.com/tianwenh/vite-plugin-ssgpage"},"plugin"),". Read ",t.createElement(e.a,{href:"https://github.com/tianwenh/vite-plugin-ssgpage/tree/main/examples/blog"},"example README")," for detailed instructions."),`
...
`,t.createElement(e.p,null,"Finally, ",t.createElement(e.a,{href:"https://github.com/tianwenh/tianwenh.github.io"},"website source code")," is here."))}}var U=[{component:H,filepath:"/home/runner/work/tianwenh.github.io/tianwenh.github.io/pages/how-this-blog-is-built/index.md",slug:"how-this-blog-is-built",frontmatter:{title:"How this blog is built",date:"2022-01-08T00:00:00.000Z",subtitle:"Yet another static site generator built in 2022.",tags:[],only:!1,hide:!1}}];const E=U.sort((n,a)=>new Date(a.frontmatter.date).getTime()-new Date(n.frontmatter.date).getTime()),N=E.reduce((n,a)=>(a.frontmatter.tags.forEach(r=>{var e;n[r]=[...(e=n[r])!=null?e:[],a]}),n),{}),W=Object.entries(N).reduce((n,[a,r])=>{var s;const e=k(a);return n[e]=[...(s=n[e])!=null?s:[],...r],n},{}),_=Object.keys(N);const l=p.exports.jsx,i=p.exports.jsxs,m=p.exports.Fragment,$=()=>i("div",{className:"layout-container",children:[l("header",{className:"layout-head",children:i("h3",{children:[l(g,{to:"/",children:"HTW"}),l(V,{})]})}),l("main",{children:l(L,{})})]});function J(){return typeof window=="undefined"?!1:R()==="dark"}const V=()=>{const n=e=>e?"dark":"light",[a,r]=d.exports.useState(J());return d.exports.useEffect(()=>{O(n(a))},[a]),l("span",{className:"dark-toggle",onClick:()=>r(!a),children:a?"\u{1F318}":"\u{1F314}"})},v=n=>{const a=k(n.tag);return i(P,{to:`/tags/${a}`,className:({isActive:r})=>{var e;return C({[(e=n.className)!=null?e:""]:!0,"tag-active":r})},children:["#",n.tag]})},x=n=>{const a=new Date(n.page.frontmatter.date).toLocaleDateString();return i(m,{children:[l("h2",{className:"page-title",children:l(g,{to:`/${n.page.slug}`,children:n.page.frontmatter.title})}),l("p",{className:"page-subtitle",children:n.page.frontmatter.subtitle}),i("small",{children:[l("time",{dateTime:a,className:"page-info",children:a}),n.page.frontmatter.tags.map(r=>l(v,{tag:r,className:"page-info"},r))]})]})},K=n=>{if(/^https?:\/\//.test(n.href))return l("a",u({target:"_blank"},n));const r=n.href.replace(/\.mdx?/,"");return r.startsWith("#")?l("a",u({},n)):l(g,y(u({},n),{to:r}))},Y={a:K},Z=n=>i(m,{children:[l("header",{children:l(x,{page:n.page})}),l("hr",{}),l(n.page.component,{components:Y}),l("hr",{}),l("footer",{children:"EOF"})]}),S=n=>l(m,{children:n.pages.map(a=>l("article",{className:"card pages-card",children:l(x,{page:a})},a.slug))}),Q=n=>{const a=n&&W[n];return!a||a.length===0?l("div",{children:"No pages..."}):l(S,{pages:a})},T=()=>{const{tagSlug:n}=X();return i(m,{children:[l("section",{className:"tags",children:_.map(a=>l(v,{tag:a,className:"card tag-card"},a))}),l("hr",{}),Q(n)]})},ee=()=>l(m,{children:"404 Not Found..."});function te(){return ne(),ae(),l(z,{children:i(c,{path:"/",element:l($,{}),children:[l(c,{index:!0,element:l(S,{pages:E})}),l(c,{path:"/tags",element:l(T,{})}),l(c,{path:"/tags/:tagSlug",element:l(T,{})}),E.map(n=>l(c,{path:`/${n.slug}`,element:l(Z,{page:n})},n.slug)),l(c,{path:"*",element:l(ee,{})})]})})}function ne(){const{pathname:n}=b();d.exports.useEffect(()=>{window.scrollTo(0,0)},[n])}function ae(){const{hash:n}=b();d.exports.useEffect(()=>{const a=document.getElementById(n.slice(1));a==null||a.scrollIntoView({behavior:"smooth"})},[])}B();const le=G.hydrate;le(l(t.StrictMode,{children:l(q,{children:l(te,{})})}),document.getElementById("app"));
