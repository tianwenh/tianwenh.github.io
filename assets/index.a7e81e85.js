var D=Object.defineProperty,M=Object.defineProperties;var F=Object.getOwnPropertyDescriptors;var E=Object.getOwnPropertySymbols;var L=Object.prototype.hasOwnProperty,O=Object.prototype.propertyIsEnumerable;var w=(n,a,l)=>a in n?D(n,a,{enumerable:!0,configurable:!0,writable:!0,value:l}):n[a]=l,h=(n,a)=>{for(var l in a||(a={}))L.call(a,l)&&w(n,l,a[l]);if(E)for(var l of E(a))O.call(a,l)&&w(n,l,a[l]);return n},b=(n,a)=>M(n,F(a));import{R as t,j as g,L as p,O as R,r as u,N as C,u as P,a as X,b as c,c as y,d as B,B as q}from"./vendor.7f38d8b9.js";const z=function(){const a=document.createElement("link").relList;if(a&&a.supports&&a.supports("modulepreload"))return;for(const o of document.querySelectorAll('link[rel="modulepreload"]'))e(o);new MutationObserver(o=>{for(const s of o)if(s.type==="childList")for(const d of s.addedNodes)d.tagName==="LINK"&&d.rel==="modulepreload"&&e(d)}).observe(document,{childList:!0,subtree:!0});function l(o){const s={};return o.integrity&&(s.integrity=o.integrity),o.referrerpolicy&&(s.referrerPolicy=o.referrerpolicy),o.crossorigin==="use-credentials"?s.credentials="include":o.crossorigin==="anonymous"?s.credentials="omit":s.credentials="same-origin",s}function e(o){if(o.ep)return;o.ep=!0;const s=l(o);fetch(o.href,s)}};z();function A(n={}){const{wrapper:a}=n.components||{};return a?t.createElement(a,n,t.createElement(l)):l();function l(){const e=Object.assign({blockquote:"blockquote",p:"p",a:"a",h2:"h2",ol:"ol",li:"li",ul:"ul",code:"code",h3:"h3"},n.components);return t.createElement(t.Fragment,null,t.createElement(e.blockquote,null,`
...
`,t.createElement(e.p,null,"Finally, code is ",t.createElement(e.a,{href:"https://github.com/tianwenh/tianwenh.github.io"},"here"),"."))}}var G=[{component:A,filepath:"/home/runner/work/tianwenh.github.io/tianwenh.github.io/pages/how-this-blog-is-built/index.md",slug:"how-this-blog-is-built",frontmatter:{title:"How this blog is built",date:"2022-01-08T00:00:00.000Z",subtitle:"Yet another static site generator built in 2022.",tags:[],only:!1,hide:!1}}];function k(n){return n.toLowerCase().trim().replace(/[^\w\s-]/g,"-").replace(/[\s_-]+/g,"-").replace(/^-+|-+$/g,"")}function _(n){return Object.entries(n).filter(([,l])=>l).map(([l])=>l).join(" ")}const $=()=>{var l;const n=window.matchMedia("(prefers-color-scheme: dark)"),a=(l=x())!=null?l:n.matches?"dark":"light";N(a),requestAnimationFrame(()=>{document.body.style.transition="color 0.5s ease-out, background 0.5s ease-out"})},x=()=>localStorage.getItem("theme"),N=n=>{n==="dark"?document.documentElement.className="dark":document.documentElement.className="",localStorage.setItem("theme",n)},f=G.sort((n,a)=>new Date(a.frontmatter.date).getTime()-new Date(n.frontmatter.date).getTime()),v=f.reduce((n,a)=>(a.frontmatter.tags.forEach(l=>{var e;n[l]=[...(e=n[l])!=null?e:[],a]}),n),{}),H=Object.entries(v).reduce((n,[a,l])=>{var o;const e=k(a);return n[e]=[...(o=n[e])!=null?o:[],...l],n},{}),U=Object.keys(v);const r=g.exports.jsx,i=g.exports.jsxs,m=g.exports.Fragment,J=()=>i("div",{className:"layout-container",children:[r("header",{className:"layout-head",children:i("h3",{children:[r(p,{to:"/",children:"HTW"}),r(W,{})]})}),r("main",{children:r(R,{})})]});function V(){return typeof window=="undefined"?!1:x()==="dark"}const W=()=>{const n=e=>e?"dark":"light",[a,l]=u.exports.useState(V());return u.exports.useEffect(()=>{N(n(a))},[a]),r("span",{className:"dark-toggle",onClick:()=>l(!a),children:a?"\u{1F318}":"\u{1F314}"})},S=n=>{const a=k(n.tag);return i(C,{to:`/tags/${a}`,className:({isActive:l})=>{var e;return _({[(e=n.className)!=null?e:""]:!0,"tag-active":l})},children:["#",n.tag]})},I=n=>{const a=new Date(n.page.frontmatter.date).toLocaleDateString();return i(m,{children:[r("h2",{className:"page-title",children:r(p,{to:`/${n.page.slug}`,children:n.page.frontmatter.title})}),r("p",{className:"page-subtitle",children:n.page.frontmatter.subtitle}),i("small",{children:[r("time",{dateTime:a,className:"page-info",children:a}),n.page.frontmatter.tags.map(l=>r(S,{tag:l,className:"page-info"},l))]})]})},K=n=>{if(/^https?:\/\//.test(n.href))return r("a",h({target:"_blank"},n));const l=n.href.replace(/\.mdx?/,"");return r(p,b(h({},n),{to:l}))},Q={a:K},Y=n=>i(m,{children:[r("header",{children:r(I,{page:n.page})}),r("hr",{}),r(n.page.component,{components:Q}),r("hr",{}),r("footer",{children:"EOF"})]}),T=n=>r(m,{children:n.pages.map(a=>r("article",{className:"card pages-card",children:r(I,{page:a})},a.slug))}),Z=n=>{const a=n&&H[n];return!a||a.length===0?r("div",{children:"No pages..."}):r(T,{pages:a})},j=()=>{const{tagSlug:n}=P();return i(m,{children:[r("section",{className:"tags",children:U.map(a=>r(S,{tag:a,className:"card tag-card"},a))}),r("hr",{}),Z(n)]})},ee=()=>r(m,{children:"404 Not Found..."});function te(){return ne(),ae(),r(X,{children:i(c,{path:"/",element:r(J,{}),children:[r(c,{index:!0,element:r(T,{pages:f})}),r(c,{path:"/tags",element:r(j,{})}),r(c,{path:"/tags/:tagSlug",element:r(j,{})}),f.map(n=>r(c,{path:`/${n.slug}`,element:r(Y,{page:n})},n.slug)),r(c,{path:"*",element:r(ee,{})})]})})}function ne(){const{pathname:n}=y();u.exports.useEffect(()=>{window.scrollTo(0,0)},[n])}function ae(){const{hash:n}=y();u.exports.useEffect(()=>{const a=document.getElementById(n.slice(1));a==null||a.scrollIntoView({behavior:"smooth"})},[])}$();const re=B.hydrate;re(r(t.StrictMode,{children:r(q,{children:r(te,{})})}),document.getElementById("app"));
