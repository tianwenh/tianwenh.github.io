...
`,e.exports.jsxs(s.p,{children:["Finally, ",e.exports.jsx(s.a,{href:"https://github.com/tianwenh/tianwenh.github.io",children:"website source code"})," is here."]})]})}}var G=[{component:A,filepath:"/home/runner/work/tianwenh.github.io/tianwenh.github.io/pages/how-this-blog-is-built/index.md",slug:"how-this-blog-is-built",frontmatter:{title:"How this blog is built",date:"2022-01-08T00:00:00.000Z",subtitle:"Yet another static site generator built in 2022.",tags:[],only:!1,hide:!1}}];const h=G.sort((t,r)=>new Date(r.frontmatter.date).getTime()-new Date(t.frontmatter.date).getTime()),f=h.reduce((t,r)=>(r.frontmatter.tags.forEach(n=>{var s;t[n]=[...(s=t[n])!=null?s:[],r]}),t),{}),q=Object.entries(f).reduce((t,[r,n])=>{var o;const s=g(r);return t[s]=[...(o=t[s])!=null?o:[],...n],t},{}),U=Object.keys(f);const W=()=>e.exports.jsxs("div",{className:"layout-container",children:[e.exports.jsx("header",{className:"layout-head",children:e.exports.jsxs("h3",{children:[e.exports.jsx(d,{to:"/",children:"HTW"}),e.exports.jsx($,{className:"dark-toggle"})]})}),e.exports.jsx("main",{children:e.exports.jsx(F,{})})]});function _(){return typeof window=="undefined"?!1:M()==="dark"}const $=t=>{const r=o=>o?"dark":"light",[n,s]=c.exports.useState(_());return c.exports.useEffect(()=>{I(r(n))},[n]),e.exports.jsx("span",x(l({},t),{onClick:()=>s(!n),children:n?"\u{1F318}":"\u{1F314}"}))},w=t=>{const r=g(t.tag);return e.exports.jsxs(O,{to:`/tags/${r}`,className:({isActive:n})=>{var s;return L({[(s=t.className)!=null?s:""]:!0,"tag-active":n})},children:["#",t.tag]})},b=t=>{const r=new Date(t.page.frontmatter.date).toLocaleDateString();return e.exports.jsxs(e.exports.Fragment,{children:[e.exports.jsx("h2",{className:"page-title",children:e.exports.jsx(d,{to:`/${t.page.slug}`,children:t.page.frontmatter.title})}),e.exports.jsx("p",{className:"page-subtitle",children:t.page.frontmatter.subtitle}),e.exports.jsxs("small",{children:[e.exports.jsx("time",{dateTime:r,className:"page-info",children:r}),t.page.frontmatter.tags.map(n=>e.exports.jsx(w,{tag:n,className:"page-info"},n))]})]})},H=t=>{if(/^https?:\/\//.test(t.href))return e.exports.jsx("a",l({target:"_blank"},t));const n=t.href.replace(/\.mdx?/,"");return n.startsWith("#")?e.exports.jsx("a",l({},t)):e.exports.jsx(d,x(l({},t),{to:n}))},J={a:H},V=t=>e.exports.jsxs(e.exports.Fragment,{children:[e.exports.jsx("header",{children:e.exports.jsx(b,{page:t.page})}),e.exports.jsx("hr",{}),e.exports.jsx(t.page.component,{components:J}),e.exports.jsx("hr",{}),e.exports.jsx("footer",{children:"EOF"})]}),y=t=>e.exports.jsx(e.exports.Fragment,{children:t.pages.map(r=>e.exports.jsx("article",{className:"card pages-card",children:e.exports.jsx(b,{page:r})},r.slug))}),K=t=>{const r=t&&q[t];return!r||r.length===0?e.exports.jsx("div",{children:"No pages..."}):e.exports.jsx(y,{pages:r})},k=()=>{const{tagSlug:t}=E();return e.exports.jsxs(e.exports.Fragment,{children:[e.exports.jsx("section",{className:"tags",children:U.map(r=>e.exports.jsx(w,{tag:r,className:"card tag-card"},r))}),e.exports.jsx("hr",{}),K(t)]})},Y=()=>e.exports.jsx(e.exports.Fragment,{children:"404 Not Found..."});function Z(){return Q(),ee(),e.exports.jsx(R,{children:e.exports.jsxs(a,{path:"/",element:e.exports.jsx(W,{}),children:[e.exports.jsx(a,{index:!0,element:e.exports.jsx(y,{pages:h})}),e.exports.jsx(a,{path:"/tags",element:e.exports.jsx(k,{})}),e.exports.jsx(a,{path:"/tags/:tagSlug",element:e.exports.jsx(k,{})}),h.map(t=>e.exports.jsx(a,{path:`/${t.slug}`,element:e.exports.jsx(V,{page:t})},t.slug)),e.exports.jsx(a,{path:"*",element:e.exports.jsx(Y,{})})]})})}function Q(){const{pathname:t}=j();c.exports.useEffect(()=>{window.scrollTo(0,0)},[t])}function ee(){const{hash:t}=j();c.exports.useEffect(()=>{const r=document.getElementById(t.slice(1));r==null||r.scrollIntoView({behavior:"smooth"})},[])}P();const se=C.hydrate;se(e.exports.jsx(X.StrictMode,{children:e.exports.jsx(z,{children:e.exports.jsx(Z,{})})}),document.getElementById("app"));
